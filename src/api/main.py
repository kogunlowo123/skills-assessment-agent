"""Skills Assessment Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Skills assessment agent that designs and administers competency assessments, validates skill claims, benchmarks against industry standards, generates skill profiles, and provides development recommendations.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
